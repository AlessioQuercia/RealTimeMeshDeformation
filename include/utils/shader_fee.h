...
public:
    ...
    // ------------------------------------------------------------------------
    ShaderFee(const char* vertexPath)
    {
    ...
    void setVec3(const std::string &name, int count, const glm::vec3 &value) const
    { 
    ...
    // ------------------------------------------------------------------------
    void setUniform1i(const std::string &name, int index)
    {
